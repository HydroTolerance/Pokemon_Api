              ...
              <div className=" hover:border-red-500 relative">
                <SidebarIcon
                  icon={
                    <IoSearch
                      size={"28"}
                      className=" w-8 h-8 absolute ml-72 flex bottom-10 top-4 right-3 justify-end items-end text-gray-400 pointer-events-none"
                    />
                  }
                />
                <input
                  ...
                  >
                    ...
                    <div className="relative py-7 overflow-hidden">
                      ...
                      <div className="pt-24 pb-3 z-10">
                        ...
                        <p className="">#{("000" + post.id).slice(-4)}</p>
                      </div>
                      <div
